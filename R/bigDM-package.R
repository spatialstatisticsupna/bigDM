...
#'
#' @seealso See \href{https://emi-sstcdapp.unavarra.es/bigDM/bigDM.html}{\code{vignette("bigDM")}} for a detailed analysis using Spain colorectal cancer mortality data.
#'
#' @examples
