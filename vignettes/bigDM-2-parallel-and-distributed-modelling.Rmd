...
When fitting both the disjoint and k-order neighbour models with the __bigDM__ package [@orozco2020] parallel or distributed computation strategies can be performed to speed up computations by using the __future__ package [@bengtsson2020unifying]. 
